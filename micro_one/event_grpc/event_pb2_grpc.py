...
from event_grpc import event_pb2 as event__pb2
...
class EventServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetAllRecords = channel.unary_unary(
                '/Event.EventService/GetAllRecords',
                request_serializer=event__pb2.query.SerializeToString,
                response_deserializer=event__pb2.Record.FromString,
                )
...
def add_EventServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetAllRecords': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=event__pb2.Record.SerializeToString,
            ),
    }
...
class EventService(object):
    ...
    def GetAllRecords(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Event.EventService/GetAllRecords',
            event__pb2.query.SerializeToString,
            event__pb2.Record.FromString,
